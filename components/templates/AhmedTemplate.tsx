    ...
    <InvitationProvider data={data}>
      <LanguageProvider>
        <div className="min-h-screen relative overflow-hidden">
          ...
          >
            <AhmedMainPage introFinished={introFinished} />
          </div>
        </div>
      </LanguageProvider>
    </InvitationProvider>
