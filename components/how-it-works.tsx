...
const steps = [
  { number: "01", icon: MessageSquare, titleKey: "how.s1.title", descKey: "how.s1.desc", color: "bg-teal/8 text-teal" },
  { number: "02", icon: Paintbrush, titleKey: "how.s2.title", descKey: "how.s2.desc", color: "bg-primary/8 text-primary" },
  { number: "03", icon: Rocket, titleKey: "how.s3.title", descKey: "how.s3.desc", color: "bg-emerald/8 text-emerald" },
  { number: "04", icon: PartyPopper, titleKey: "how.s4.title", descKey: "how.s4.desc", color: "bg-rose/8 text-rose" },
] as const
      ...
      <div className="max-w-6xl mx-auto relative">
        <div className="text-center mb-16 sm:mb-28">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-md glass border border-border/40 mb-6 sm:mb-8">
            ...
            <span className="text-xs sm:text-sm font-medium text-foreground/75">{t("how.badge")}</span>
          </div>
